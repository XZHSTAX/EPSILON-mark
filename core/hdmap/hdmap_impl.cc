...
#include "pointcloud/pointcloud_loader.h"
#include "road_network/lane_map.h"
#include "utils/admap_convertion.h"
#include "utils/admap_visual.h"

namespace hdmap {

ad::map::match::AdMapMatching HdMapImpl::admap_matching_;

// 把数据从map中读取，并处理，存储到lane_map中,lane_map是LaneMap类中的一个静态变量
bool HdMapImpl::LoadMap(const std::string& file, const std::string& pcd_file) {
  ...
  // 更新lane_map中每条车道的neighbor_lanes_
